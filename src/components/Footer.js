        ...
        <>
            ...
            <MediaQuery minWidth={1025}>
                <section id="footer" class="flex flex-col justify-center mt-80 ">
                    ...
                    <div class="flex flex-row justify-center m-20 gap-14 w-2/3">
                        <p class="text-end w-[30rem] font-light">Entre em contato conosco sobre seu negócio para que possamos agendar uma visita.</p>
